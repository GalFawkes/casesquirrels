"""
Django settings for casesquirrels project.
...
key_file = open(os.path.join(BASE_DIR, "prod_key.key"))
...
ROOT_URLCONF = 'casesquirrels.urls'
...
WSGI_APPLICATION = 'casesquirrels.wsgi.application'
